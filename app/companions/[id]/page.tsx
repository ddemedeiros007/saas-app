...
const CompanionSession = async({ params }: CompanionSessionPageProps) => {
    // First, check for the user's authentication status.
    ...
    // Fetch the companion after confirming the user is authenticated.
    const companion = await getCompanion(id);

    if (!companion) {
        // If the companion is not found, redirect to the companions page.
        redirect('/companions');
    }
